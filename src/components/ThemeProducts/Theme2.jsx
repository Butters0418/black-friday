...
function Theme2() {
  ...
  useEffect(() => {
    const idData = getDataById(newPdData, 99);
  ...
  return (
    <section className="theme theme2 theme-style-right" ref={container}>
      {/* 背景 */}
      <img className="theme-bg bg-1" src={theme2BgItem1} alt="black friday" />
      <img className="theme-bg bg-2" src={theme2BgItem2} alt="black friday" />
      ...
      {themeData.length > 0 && (
        <div className="theme-container">
          {/* title */}
          <h3 className="theme-title">媽咪好幫手</h3>
