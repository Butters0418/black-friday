...
function Theme3() {
  ...
  return (
    <section className="theme theme3 theme-style-left" ref={container}>
      {/* 背景 */}
      <img className="theme-bg bg-1" src={theme3BgItem1} alt="black friday" />
      <img className="theme-bg bg-2" src={theme3BgItem2} alt="black friday" />
      ...
      {themeData.length > 0 && (
        <div className="theme-container">
          {/* title */}
          <h3 className="theme-title">時尚育兒精選</h3>
